# Generation Task / 生成任务: GEN_CR_SCN_COMPOUND_20260615_020814_001

- Scene / 场戏: SCN_COMPOUND
- Change request / 变更请求: CR_SCN_COMPOUND_20260615_020814
- Trigger step / 触发步骤: 08_generation
- Asset / 资产: MSB001_FINAL_STORYBOARD
- Stage / 步骤: 08_generation
- Target version / 目标版本: v001
- Action / 动作: modify
- Source or target path / 原路径或目标路径: media/01_AIGC/final_storyboard_panels/B01/MSB001_final_storyboard_v002.jpg
- Parent version / 父版本: 
...
Main image / 主图: MSB001_FINAL_STORYBOARD
Main path / 主图路径: media/01_AIGC/final_storyboard_panels/B01/MSB001_final_storyboard_v002.jpg

Main brief / 主图备注:
- Describe the complete new image to generate from this main image.

Reference stack / 关联素材:
- No linked references. Use only the main image and note.
