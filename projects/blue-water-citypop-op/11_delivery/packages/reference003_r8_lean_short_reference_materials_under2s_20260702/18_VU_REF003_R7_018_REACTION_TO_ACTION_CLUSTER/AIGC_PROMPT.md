...
1. Reference video: `01_reference_clip_same_shot_hold_min2s_optional/VU_REF003_R7_018_REACTION_TO_ACTION_CLUSTER_reference_same_shot_hold_min2s_h264_aac.mp4` (upload-compatible H.264/AAC MP4)
...
- Original independent clip: `00_original_independent_reference_clip/VU_REF003_R7_018_REACTION_TO_ACTION_CLUSTER_reference_independent_original_duration_h264_aac.mp4`
- Optional upload workaround: `01_reference_clip_same_shot_hold_min2s_optional/VU_REF003_R7_018_REACTION_TO_ACTION_CLUSTER_reference_same_shot_hold_min2s_h264_aac.mp4`
...
|---|---:|---|---|
| `R7_CAND_018_start_047452ms` | 00:47.45 | start | `05_r7_generated_candidates_reference_only/01_R7_CAND_018_start_047452ms.png` |
| `R7_CAND_018_end_048143ms` | 00:48.14 | end | `05_r7_generated_candidates_reference_only/02_R7_CAND_018_end_048143ms.png` |
...
| ID | Time | Role | Local file |
|---|---:|---|---|
| `OP_SHOT_022` | 00:47.50 | 图6 / Jean_reaction_close | `06_official_original_keyframes_reference_only/01_official_keyframe_OP_SHOT_022.png` |
| `OP_SHOT_023` | 00:48.00 | 图1 / Grandis_action_close | `06_official_original_keyframes_reference_only/02_official_keyframe_OP_SHOT_023.png` |
