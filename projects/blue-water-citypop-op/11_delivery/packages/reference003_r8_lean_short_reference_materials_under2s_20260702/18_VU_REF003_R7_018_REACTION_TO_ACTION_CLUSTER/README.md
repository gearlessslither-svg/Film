...
- Reference clip: `01_reference_clip_same_shot_hold_min2s_optional/VU_REF003_R7_018_REACTION_TO_ACTION_CLUSTER_reference_same_shot_hold_min2s_h264_aac.mp4`
- Original independent reference clip: `00_original_independent_reference_clip/VU_REF003_R7_018_REACTION_TO_ACTION_CLUSTER_reference_independent_original_duration_h264_aac.mp4`
- Prompt: `AIGC_PROMPT.md`
- Keyframes/images for upload: 0
- Asset locks: 4
- Source reference frames, audit only: 2
- R7 generated candidates, reference only: 2
- Official original keyframes, reference only: 2
