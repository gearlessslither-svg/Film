...
1. Reference video: `01_reference_clip_same_shot_hold_min2s_optional/VU_REF003_R7_034_FINAL_SKY_TRANSITION_reference_same_shot_hold_min2s_h264_aac.mp4` (upload-compatible H.264/AAC MP4)
...
- Original independent clip: `00_original_independent_reference_clip/VU_REF003_R7_034_FINAL_SKY_TRANSITION_reference_independent_original_duration_h264_aac.mp4`
- Optional upload workaround: `01_reference_clip_same_shot_hold_min2s_optional/VU_REF003_R7_034_FINAL_SKY_TRANSITION_reference_same_shot_hold_min2s_h264_aac.mp4`
...
|---|---:|---|---|
| `R7_CAND_034_start_079234ms` | 01:19.23 | start | `05_r7_generated_candidates_reference_only/01_R7_CAND_034_start_079234ms.png` |
| `R7_CAND_034_middle_079996ms` | 01:20.00 | middle | `05_r7_generated_candidates_reference_only/02_R7_CAND_034_middle_079996ms.png` |
| `R7_CAND_034_end_080759ms` | 01:20.76 | end | `05_r7_generated_candidates_reference_only/03_R7_CAND_034_end_080759ms.png` |
...
| ID | Time | Role | Local file |
|---|---:|---|---|
| `OP_SHOT_039` | 01:19.00 | 图2 / splash_to_sky | `06_official_original_keyframes_reference_only/01_official_keyframe_OP_SHOT_039.png` |
| `OP_SHOT_040` | 01:20.00 | 图1 / final_sky_safe | `06_official_original_keyframes_reference_only/02_official_keyframe_OP_SHOT_040.png` |
...
| ID | Time | Role | Local file |
|---|---:|---|---|
| `R7_CAND_034_start_079234ms` | 01:19.23 | start | `04_source_reference_frames_audit_only/01_R7_CAND_034_start_079234ms.jpg` |
| `R7_CAND_034_middle_079996ms` | 01:20.00 | middle | `04_source_reference_frames_audit_only/02_R7_CAND_034_middle_079996ms.jpg` |
| `R7_CAND_034_end_080759ms` | 01:20.76 | end | `04_source_reference_frames_audit_only/03_R7_CAND_034_end_080759ms.jpg` |
