...
1. Reference video: `01_reference_clip_same_shot_hold_min2s_optional/VU_REF003_R7_020_VEHICLE_PREP_FLASH_reference_same_shot_hold_min2s_h264_aac.mp4` (upload-compatible H.264/AAC MP4)
...
- Original independent clip: `00_original_independent_reference_clip/VU_REF003_R7_020_VEHICLE_PREP_FLASH_reference_independent_original_duration_h264_aac.mp4`
- Optional upload workaround: `01_reference_clip_same_shot_hold_min2s_optional/VU_REF003_R7_020_VEHICLE_PREP_FLASH_reference_same_shot_hold_min2s_h264_aac.mp4`
...
- `grandis_vehicle` (official_prop_lock): `03_asset_locks_for_upload/04_props_vehicles_symbols_grandis_vehicle.png`
...
|---|---:|---|---|
| `R7_CAND_020_start_048704ms` | 00:48.70 | start | `05_r7_generated_candidates_reference_only/01_R7_CAND_020_start_048704ms.png` |
| `R7_CAND_020_end_049645ms` | 00:49.64 | end | `05_r7_generated_candidates_reference_only/02_R7_CAND_020_end_049645ms.png` |
...
| ID | Time | Role | Local file |
|---|---:|---|---|
| `R7_CAND_020_start_048704ms` | 00:48.70 | start | `04_source_reference_frames_audit_only/01_R7_CAND_020_start_048704ms.jpg` |
| `R7_CAND_020_end_049645ms` | 00:49.64 | end | `04_source_reference_frames_audit_only/02_R7_CAND_020_end_049645ms.jpg` |
