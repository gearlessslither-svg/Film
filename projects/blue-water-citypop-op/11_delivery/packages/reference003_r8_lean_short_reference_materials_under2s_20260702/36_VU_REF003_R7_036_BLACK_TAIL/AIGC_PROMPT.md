...
1. Reference video: `01_reference_clip_same_shot_hold_min2s_optional/VU_REF003_R7_036_BLACK_TAIL_reference_same_shot_hold_min2s_h264_aac.mp4` (upload-compatible H.264/AAC MP4)
...
- Original independent clip: `00_original_independent_reference_clip/VU_REF003_R7_036_BLACK_TAIL_reference_independent_original_duration_h264_aac.mp4`
- Optional upload workaround: `01_reference_clip_same_shot_hold_min2s_optional/VU_REF003_R7_036_BLACK_TAIL_reference_same_shot_hold_min2s_h264_aac.mp4`
...
|---|---:|---|---|
| `R7_CAND_036_start_083614ms` | 01:23.61 | start | `05_r7_generated_candidates_reference_only/01_R7_CAND_036_start_083614ms.png` |
| `R7_CAND_036_end_084388ms` | 01:24.39 | end | `05_r7_generated_candidates_reference_only/02_R7_CAND_036_end_084388ms.png` |
...
| ID | Time | Role | Local file |
|---|---:|---|---|
| `OP_SHOT_042` | 01:23.50 | 图1 / black_tail | `06_official_original_keyframes_reference_only/01_official_keyframe_OP_SHOT_042.png` |
...
| ID | Time | Role | Local file |
|---|---:|---|---|
| `R7_CAND_036_start_083614ms` | 01:23.61 | start | `04_source_reference_frames_audit_only/01_R7_CAND_036_start_083614ms.jpg` |
| `R7_CAND_036_end_084388ms` | 01:24.39 | end | `04_source_reference_frames_audit_only/02_R7_CAND_036_end_084388ms.jpg` |
