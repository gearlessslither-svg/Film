...
1. Reference video: `01_reference_clip_same_shot_hold_min2s_optional/VU_REF003_R7_019_GRANDIS_ACTION_INSERT_reference_same_shot_hold_min2s_h264_aac.mp4` (upload-compatible H.264/AAC MP4)
...
- Original independent clip: `00_original_independent_reference_clip/VU_REF003_R7_019_GRANDIS_ACTION_INSERT_reference_independent_original_duration_h264_aac.mp4`
- Optional upload workaround: `01_reference_clip_same_shot_hold_min2s_optional/VU_REF003_R7_019_GRANDIS_ACTION_INSERT_reference_same_shot_hold_min2s_h264_aac.mp4`
...
|---|---:|---|---|
| `R7_CAND_019_start_048203ms` | 00:48.20 | start | `05_r7_generated_candidates_reference_only/01_R7_CAND_019_start_048203ms.png` |
| `R7_CAND_019_end_048644ms` | 00:48.64 | end | `05_r7_generated_candidates_reference_only/02_R7_CAND_019_end_048644ms.png` |
...
| ID | Time | Role | Local file |
|---|---:|---|---|
| `OP_SHOT_023` | 00:48.00 | 图1 / Grandis_action_close | `06_official_original_keyframes_reference_only/01_official_keyframe_OP_SHOT_023.png` |
