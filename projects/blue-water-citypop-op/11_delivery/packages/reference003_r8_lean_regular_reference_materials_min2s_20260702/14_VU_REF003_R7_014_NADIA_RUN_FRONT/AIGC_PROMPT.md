...
1. Reference video: `01_reference_clip/VU_REF003_R7_014_NADIA_RUN_FRONT_reference_upload_h264_aac.mp4` (upload-compatible H.264/AAC MP4)
...
|---|---:|---|---|
| `R7_CAND_014_start_039530ms` | 00:39.53 | start | `05_r7_generated_candidates_reference_only/01_R7_CAND_014_start_039530ms.png` |
| `R7_CAND_014_middle_040500ms` | 00:40.50 | middle | `05_r7_generated_candidates_reference_only/02_R7_CAND_014_middle_040500ms.png` |
| `R7_CAND_014_end_041470ms` | 00:41.47 | end | `05_r7_generated_candidates_reference_only/03_R7_CAND_014_end_041470ms.png` |
...
| ID | Time | Role | Local file |
|---|---:|---|---|
| `OP_SHOT_018` | 00:39.50 | 图2 / Nadia_run_front | `06_official_original_keyframes_reference_only/01_official_keyframe_OP_SHOT_018.png` |
| `OP_SHOT_019` | 00:41.50 | 图3 / Jean_run | `06_official_original_keyframes_reference_only/02_official_keyframe_OP_SHOT_019.png` |
