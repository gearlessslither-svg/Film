# 02 - VU_REF003_R7_002_OPENING_AIRCRAFT_FLASH_LONG

- Title: 开场长段B：白鸟云层到飞行器闪现
- Time range: `00:07.00-00:16.50`
- Reference clip: `01_reference_clip/VU_REF003_R7_002_OPENING_AIRCRAFT_FLASH_LONG_reference_upload_h264_aac.mp4`
- Original independent reference clip: `same as reference clip`
- Prompt: `AIGC_PROMPT.md`
- Keyframes/images for upload: 4
- Asset locks: 2
- Source reference frames, audit only: 3
- R7 generated candidates, reference only: 3
- Official original keyframes, reference only: 3
