# 03 - VU_REF003_R7_003_OPENING_TITLE_FLARE_NADIA

- Title: 开场长段C：标题安全位到日光转Nadia
- Time range: `00:16.50-00:24.80`
- Reference clip: `01_reference_clip/VU_REF003_R7_003_OPENING_TITLE_FLARE_NADIA_reference_upload_h264_aac.mp4`
- Original independent reference clip: `same as reference clip`
- Prompt: `AIGC_PROMPT.md`
- Keyframes/images for upload: 2
- Asset locks: 2
