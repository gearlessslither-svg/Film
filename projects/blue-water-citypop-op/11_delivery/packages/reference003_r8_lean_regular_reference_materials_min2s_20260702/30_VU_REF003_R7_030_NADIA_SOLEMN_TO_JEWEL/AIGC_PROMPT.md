...
1. Reference video: `01_reference_clip/VU_REF003_R7_030_NADIA_SOLEMN_TO_JEWEL_reference_upload_h264_aac.mp4` (upload-compatible H.264/AAC MP4)
...
|---|---:|---|---|
| `R7_CAND_030_start_071393ms` | 01:11.39 | start | `05_r7_generated_candidates_reference_only/01_R7_CAND_030_start_071393ms.png` |
| `R7_CAND_030_middle_072718ms` | 01:12.72 | middle | `05_r7_generated_candidates_reference_only/02_R7_CAND_030_middle_072718ms.png` |
| `R7_CAND_030_end_074044ms` | 01:14.04 | end | `05_r7_generated_candidates_reference_only/03_R7_CAND_030_end_074044ms.png` |
...
| ID | Time | Role | Local file |
|---|---:|---|---|
| `OP_SHOT_034` | 01:12.00 | 图1 / Nadia_solemn_front | `06_official_original_keyframes_reference_only/01_official_keyframe_OP_SHOT_034.png` |
| `OP_SHOT_035` | 01:13.50 | 图1 / Blue_Water_jewel_symbol | `06_official_original_keyframes_reference_only/02_official_keyframe_OP_SHOT_035.png` |
...
| ID | Time | Role | Local file |
|---|---:|---|---|
| `R7_CAND_030_start_071393ms` | 01:11.39 | start | `04_source_reference_frames_audit_only/01_R7_CAND_030_start_071393ms.jpg` |
| `R7_CAND_030_middle_072718ms` | 01:12.72 | middle | `04_source_reference_frames_audit_only/02_R7_CAND_030_middle_072718ms.jpg` |
| `R7_CAND_030_end_074044ms` | 01:14.04 | end | `04_source_reference_frames_audit_only/03_R7_CAND_030_end_074044ms.jpg` |
