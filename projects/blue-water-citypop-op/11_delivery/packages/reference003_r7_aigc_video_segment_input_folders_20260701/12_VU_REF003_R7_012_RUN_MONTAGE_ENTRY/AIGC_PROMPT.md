...
1. Reference video: `01_reference_clip/VU_REF003_R7_012_RUN_MONTAGE_ENTRY_reference.mp4`
...
|---:|---|---|---:|---|---|
| 1 | `official_keyframe` | `OP_SHOT_016` | 00:37.00 | 图2 / Grandis_trio_close | `02_keyframes_for_upload/01_official_keyframe_OP_SHOT_016.png` |
| 2 | `r5_adaptive_generated` | `R5_VU_REF003_010_GRANDIS_TRIO_INTRO_037500ms_02` | 00:37.50 | adaptive_middle | `02_keyframes_for_upload/02_r5_adaptive_generated_R5_VU_REF003_010_GRANDIS_TRIO_INTRO_037500ms_02.png` |
| 3 | `official_keyframe` | `OP_SHOT_017` | 00:38.00 | 图1 / Nadia_run_feet | `02_keyframes_for_upload/03_official_keyframe_OP_SHOT_017.png` |
| 4 | `r7_generated_candidate` | `R7_CAND_012_start_037234ms` | 00:37.23 | start | `02_keyframes_for_upload/04_r7_generated_R7_CAND_012_start_037234ms.png` |
| 5 | `r7_generated_candidate` | `R7_CAND_012_end_038091ms` | 00:38.09 | end | `02_keyframes_for_upload/05_r7_generated_R7_CAND_012_end_038091ms.png` |
