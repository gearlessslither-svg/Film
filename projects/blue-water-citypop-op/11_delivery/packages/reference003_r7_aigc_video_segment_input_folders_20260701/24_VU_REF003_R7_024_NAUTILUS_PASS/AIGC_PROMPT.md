...
1. Reference video: `01_reference_clip/VU_REF003_R7_024_NAUTILUS_PASS_reference.mp4`
...
|---:|---|---|---:|---|---|
| 1 | `official_keyframe` | `OP_SHOT_027` | 00:55.00 | 图2 / undersea_pass | `02_keyframes_for_upload/01_official_keyframe_OP_SHOT_027.png` |
| 2 | `r5_adaptive_generated` | `R5_VU_REF003_013_NAUTILUS_UNDERSEA_CREDITS_057000ms_03` | 00:57.00 | adaptive_middle | `02_keyframes_for_upload/02_r5_adaptive_generated_R5_VU_REF003_013_NAUTILUS_UNDERSEA_CREDITS_057000ms_03.png` |
| 3 | `r7_generated_candidate` | `R7_CAND_024_start_055030ms` | 00:55.03 | start | `02_keyframes_for_upload/03_r7_generated_R7_CAND_024_start_055030ms.png` |
| 4 | `r7_generated_candidate` | `R7_CAND_024_middle_056000ms` | 00:56.00 | middle | `02_keyframes_for_upload/04_r7_generated_R7_CAND_024_middle_056000ms.png` |
| 5 | `r7_generated_candidate` | `R7_CAND_024_end_056970ms` | 00:56.97 | end | `02_keyframes_for_upload/05_r7_generated_R7_CAND_024_end_056970ms.png` |
...
|---|---:|---|---|
| `R7_CAND_024_start_055030ms` | 00:55.03 | start | `04_source_reference_frames_audit_only/01_R7_CAND_024_start_055030ms.jpg` |
| `R7_CAND_024_middle_056000ms` | 00:56.00 | middle | `04_source_reference_frames_audit_only/02_R7_CAND_024_middle_056000ms.jpg` |
| `R7_CAND_024_end_056970ms` | 00:56.97 | end | `04_source_reference_frames_audit_only/03_R7_CAND_024_end_056970ms.jpg` |
