...
1. Reference video: `01_reference_clip/VU_REF003_R7_004_NADIA_PROFILE_CONTINUE_reference.mp4`
...
|---:|---|---|---:|---|---|
| 1 | `official_keyframe` | `OP_SHOT_010` | 00:24.50 | 图1 / Nadia_profile | `02_keyframes_for_upload/01_official_keyframe_OP_SHOT_010.png` |
| 2 | `r7_generated_candidate` | `R7_CAND_004_start_024830ms` | 00:24.83 | start | `02_keyframes_for_upload/02_r7_generated_R7_CAND_004_start_024830ms.png` |
| 3 | `r7_generated_candidate` | `R7_CAND_004_end_025871ms` | 00:25.87 | end | `02_keyframes_for_upload/03_r7_generated_R7_CAND_004_end_025871ms.png` |
