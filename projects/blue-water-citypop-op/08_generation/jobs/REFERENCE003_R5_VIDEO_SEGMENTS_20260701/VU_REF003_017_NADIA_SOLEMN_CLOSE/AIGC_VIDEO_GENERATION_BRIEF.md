# AIGC Video Generation Brief — VU_REF003_017_NADIA_SOLEMN_CLOSE — R5 Expanded Package

## Required Inputs

- Reference video clip: `reference_clip/VU_REF003_017_NADIA_SOLEMN_CLOSE_reference.mp4`
- Ordered keyframe anchors: 1 total = 1 official + 0 R5 adaptive generated
- 图1 = `OP_SHOT_034` (official_keyframe, 01:12.00, 图1 / Nadia_solemn_front): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_017_NADIA_SOLEMN_CLOSE/keyframes/01_OP_SHOT_034.png`
  - function: Nadia 庄重正面
...
- `nadia` (official_identity_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_017_NADIA_SOLEMN_CLOSE/asset_locks/characters_nadia.png`
- `jean` (official_identity_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_017_NADIA_SOLEMN_CLOSE/asset_locks/characters_jean.png`
- `marie` (official_identity_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_017_NADIA_SOLEMN_CLOSE/asset_locks/characters_marie.png`
- `king` (official_identity_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_017_NADIA_SOLEMN_CLOSE/asset_locks/characters_king.png`
- `grandis` (official_identity_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_017_NADIA_SOLEMN_CLOSE/asset_locks/characters_grandis.png`
- `sanson` (official_identity_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_017_NADIA_SOLEMN_CLOSE/asset_locks/characters_sanson.png`
- `hanson` (official_identity_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_017_NADIA_SOLEMN_CLOSE/asset_locks/characters_hanson.png`
- `nemo` (official_identity_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_017_NADIA_SOLEMN_CLOSE/asset_locks/characters_nemo.png`
...
- `blue_water_pendant` (official_prop_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_017_NADIA_SOLEMN_CLOSE/asset_locks/props_vehicles_symbols_blue_water_pendant.png`
- `white_bird` (official_prop_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_017_NADIA_SOLEMN_CLOSE/asset_locks/props_vehicles_symbols_white_bird.png`
- `jean_aircraft` (official_prop_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_017_NADIA_SOLEMN_CLOSE/asset_locks/props_vehicles_symbols_jean_aircraft.png`
- `grandis_vehicle` (official_prop_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_017_NADIA_SOLEMN_CLOSE/asset_locks/props_vehicles_symbols_grandis_vehicle.png`
- `nautilus` (official_prop_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_017_NADIA_SOLEMN_CLOSE/asset_locks/props_vehicles_symbols_nautilus.png`
- `blue_grid_geometry` (official_scene_symbol_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_017_NADIA_SOLEMN_CLOSE/asset_locks/props_vehicles_symbols_blue_grid_geometry.png`
- `water_burst_transition` (official_transition_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_017_NADIA_SOLEMN_CLOSE/asset_locks/props_vehicles_symbols_water_burst_transition.png`
- Expected output path: `08_generation/outputs/video/reference003_r5_expanded_segments/VU_REF003_017_NADIA_SOLEMN_CLOSE.mp4`
...
Generate a clean live-action remake segment for `VU_REF003_017_NADIA_SOLEMN_CLOSE`. Preserve
...
# VU_REF003_017_NADIA_SOLEMN_CLOSE - Nadia 庄重正面近景

- Unit type: `solemn_character_close`
- Time range: 01:11.50-01:13.00
...
- 图1 = `OP_SHOT_034` (图1 / Nadia_solemn_front, 01:12.00): Nadia C-version front close-up in cool symbolic light, serious and age-safe.

## Script Intent

Nadia 进入更严肃、静止、象征性的正面近景。

## Frame Relationships

Nadia C 锁定，年龄安全，服装保守。

Incoming: TE_REF003_033_033_TO_034  
Intra: none  
Outgoing: TE_REF003_034_034_TO_035

## Camera Plan

- Movement: still portrait hold
- Framing: front close-up, shoulders safe and modest
- Lens: portrait lens
- Screen Direction: direct gaze
- Focus: eyes and face
- Lighting: cool blue symbolic light
