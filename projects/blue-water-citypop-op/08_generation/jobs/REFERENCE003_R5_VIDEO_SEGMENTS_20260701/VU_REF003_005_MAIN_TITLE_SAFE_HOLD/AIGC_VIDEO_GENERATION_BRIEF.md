# AIGC Video Generation Brief — VU_REF003_005_MAIN_TITLE_SAFE_HOLD — R5 Expanded Package

## Required Inputs

- Reference video clip: `reference_clip/VU_REF003_005_MAIN_TITLE_SAFE_HOLD_reference.mp4`
- Ordered keyframe anchors: 2 total = 1 official + 1 R5 adaptive generated
- 图1 = `R5_VU_REF003_005_MAIN_TITLE_SAFE_HOLD_017000ms_01` (r5_adaptive_generated, 00:17.00, adaptive_primary): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_005_MAIN_TITLE_SAFE_HOLD/keyframes/01_R5_VU_REF003_005_MAIN_TITLE_SAFE_HOLD_017000ms_01.png`
  - function: 主标题功能位无字 hold: large timeline gap between existing anchors; visually different from nearest existing anchor; local motion/color change peak
- 图2 = `OP_SHOT_008` (official_keyframe, 00:18.50, 图1 / main_title_safe_no_text): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_005_MAIN_TITLE_SAFE_HOLD/keyframes/02_OP_SHOT_008.png`
  - function: 主标题无字安全位
...
- `nadia` (official_identity_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_005_MAIN_TITLE_SAFE_HOLD/asset_locks/characters_nadia.png`
- `jean` (official_identity_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_005_MAIN_TITLE_SAFE_HOLD/asset_locks/characters_jean.png`
- `marie` (official_identity_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_005_MAIN_TITLE_SAFE_HOLD/asset_locks/characters_marie.png`
- `king` (official_identity_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_005_MAIN_TITLE_SAFE_HOLD/asset_locks/characters_king.png`
- `grandis` (official_identity_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_005_MAIN_TITLE_SAFE_HOLD/asset_locks/characters_grandis.png`
- `sanson` (official_identity_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_005_MAIN_TITLE_SAFE_HOLD/asset_locks/characters_sanson.png`
- `hanson` (official_identity_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_005_MAIN_TITLE_SAFE_HOLD/asset_locks/characters_hanson.png`
- `nemo` (official_identity_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_005_MAIN_TITLE_SAFE_HOLD/asset_locks/characters_nemo.png`
...
- `blue_water_pendant` (official_prop_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_005_MAIN_TITLE_SAFE_HOLD/asset_locks/props_vehicles_symbols_blue_water_pendant.png`
- `white_bird` (official_prop_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_005_MAIN_TITLE_SAFE_HOLD/asset_locks/props_vehicles_symbols_white_bird.png`
- `jean_aircraft` (official_prop_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_005_MAIN_TITLE_SAFE_HOLD/asset_locks/props_vehicles_symbols_jean_aircraft.png`
- `grandis_vehicle` (official_prop_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_005_MAIN_TITLE_SAFE_HOLD/asset_locks/props_vehicles_symbols_grandis_vehicle.png`
- `nautilus` (official_prop_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_005_MAIN_TITLE_SAFE_HOLD/asset_locks/props_vehicles_symbols_nautilus.png`
- `blue_grid_geometry` (official_scene_symbol_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_005_MAIN_TITLE_SAFE_HOLD/asset_locks/props_vehicles_symbols_blue_grid_geometry.png`
- `water_burst_transition` (official_transition_lock): `08_generation/jobs/REFERENCE003_R5_VIDEO_SEGMENTS_20260701/VU_REF003_005_MAIN_TITLE_SAFE_HOLD/asset_locks/props_vehicles_symbols_water_burst_transition.png`
- Expected output path: `08_generation/outputs/video/reference003_r5_expanded_segments/VU_REF003_005_MAIN_TITLE_SAFE_HOLD.mp4`
